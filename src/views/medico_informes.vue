    ...
    <div class="w-100 px-4 py-3">
        ...
        <div class="row">
            ...
            <div :class="activacion ? 'col-12' : 'col-10'">
                ...
                <div class="table-responsive" v-if="activacion && tipoInforme === '1'" style="max-height: 60vh; overflow-y: auto;">
                ...
                <nav v-if="activacion && tipoInforme === '1' && totalPaginas > 1" aria-label="Paginacion" class="mt-3">
...
export default {
    ...
    methods: {
        ...
        ...mapActions(["GetAllRegistersbyRangeMed", "getAllActividadesExtra", "getdataips"]),
