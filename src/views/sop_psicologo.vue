        ...
        <div v-else>
            ...
            <ul class="nav nav-tabs mb-3" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#psi-pendientes" type="button" role="tab">
                        Pendientes ({{ cantEncuestasPendientes }})
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#psi-devueltos" type="button" role="tab">
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="psi-pendientes" role="tabpanel">
                            ...
                            <div :class="['row', 'paciente', 'shadow-sm', pacienteClass(encuesta)]">
                                <div class="col-12 col-md-10 paciente-info-col">
                                    <div class="paciente-nombre">
                                        <strong>{{ encuesta.nombre1 }} {{ encuesta.nombre2 }} {{ encuesta.apellido1 }} {{ encuesta.apellido2 }}</strong>
                                    </div>
                                    ...
                                    <small class="paciente-meta">
                                        <span>Nac: {{ formatearFechaCorta(encuesta.fechaNac) || 'N/A' }}</span>
                                        <span>Enc: {{ formatearFechaCorta(encuesta.fecha) || 'N/A' }}</span>
                                    </small>
                ...
                <div class="tab-pane fade" id="psi-devueltos" role="tabpanel">
...
export default {
    ...
    methods: {
        ...
        getStatusKeyBandeja() {
            return "status_gest_psicologo";
        },
        getFechaKeyBandeja() {
            return "fechagestPsicologo";
        },
